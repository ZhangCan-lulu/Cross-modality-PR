...
def main():
    ...
    parser.add_argument('--resume', '-r',
                        default='sysu_id_epoch10_debug_gloid_expcenter_pcb_cbam_debug_pyramid_attention_drop_0.0_lr_1.0e-02_dim_512_resnet50_use_cbam_best.t',
                        type=str,
    ...
    os.environ['CUDA_VISIBLE_DEVICES'] = '3'  # args.gpu
    np.random.seed(0)
